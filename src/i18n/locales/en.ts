...
export default {
  ...
  NO_FYWINNV: "No fywinnv services available to update bed information.",
  ACCEPT: "Accept",
  ...
  ABOUT_BCN: "About Big Country Navigator App",
  ...
  YOU_REACHED_LIMIT_SERVICE:
    "You reached the Max Limit for adding new services. Please check with App Admin at fywinnvappinfo@gmail.com to request access to add more services.",
  TEXT: "TEXT",
  ...
  // intro
  SKIP: "SKIP",
  WELCOME_FYWINNV: "Welcome to Big Country Navigator App",
  SLIDE_1:
