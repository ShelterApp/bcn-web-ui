...
const SideBar = React.memo((props: SideBarProps) => {
    ...
    const [topKudos, setTopKudos] = useState(
        Boolean(JSON.parse(sessionStorage.getItem("@fywinnv_isTopKudos")))
    );

    const setSortTopKudos = (open) => {
        sessionStorage.setItem("@fywinnv_isTopKudos", JSON.stringify(open));
        window.scrollTo(0, 0);
        let params = {
            skip: 0,
            sort: open ? "likes" : "",
    ...
    const list = () => (
        ...
        >
            ...
            <ListItem className={classes.listSelections}>
                {["MEN", "WOMEN", "YOUTH_AND_KIDS", "ALL"].map(
                    (text, index) => {
                        return (
                            <span
                                className={clsx(
            ...
            <ListItem className={classes.listSelections}>
                {["SENIORS", "DISABLED", "FAMILIES", "LGBT"].map(
                    (text, index) => {
                        return (
                            <span
                                className={clsx(
                    ...
                    {role === "admin" && (
                        <>
                            ...
                            >
                                ...
                                <ListItemText
                                    primary={translate("ADD_CRISIS_LINE")}
                                />
                            </ListItem>
                            {/* <Divider />
              <ListItem
              ...
              <Divider />
                    ...
                    >
                        ...
                        <Badge
                            ...
                            badgeContent={
                                badges ? Number(badges.countManagedServices) : 0
                            }
                            color="error"
                        >
                            <ListItemText
                                primary={translate("MANAGE_SERVICES")}
                            />
                        </Badge>
                    </ListItem>
                    <Divider />
                    ...
                    >
                        ...
                        <Badge
                            ...
                            badgeContent={
                                badges ? Number(badges.countUnReadFeedbacks) : 0
                            }
                            color="error"
                        >
                            <ListItemText
                                primary={translate("MANAGE_FEEDBACK")}
                            />
                        </Badge>
                    </ListItem>
                    <Divider />
                    {!!(
                        ...
                        >
                            ...
                            <Badge
                                ...
                                badgeContent={
                                    badges
                                        ? Number(badges.countManagedShelters)
                                        : 0
                                }
                                color="error"
                            >
                                <ListItemText
                                    primary={translate("UPDATE_SHELTER")}
                                />
                            </Badge>
                        </ListItem>
                    )}
                    {current_user.isAdmin ? (
                        <>
                            ...
                            >
                                ...
                                <Badge
                                    ...
                                    badgeContent={
                                        badges
                                            ? Number(
                                                  badges.countNotApprovedServices
                                              )
                                            : 0
                                    }
                                    color="error"
                                >
                                    <ListItemText
                                        primary={translate("MANAGE_APPROVALS")}
                                    />
                                </Badge>
                            </ListItem>
                            <Divider />
                            ...
                            >
                                ...
                                <Badge
                                    ...
                                    badgeContent={
                                        badges
                                            ? Number(badges.countTotalUsers)
                                            : 0
                                    }
                                    color="error"
                                >
                                    <ListItemText
                                        primary={translate("MANAGE_USERS")}
                                    />
                                </Badge>
                            </ListItem>
                        </>
                        ...
                        <>
                            ...
                            >
                                ...
                                <ListItemText
                                    primary={translate("MANAGE_PROFILE")}
                                />
                            </ListItem>
                        </>
                    )}
                    {current_user.lastMethod === "LOCAL" && (
                        <>
                            ...
                            >
                                ...
                                <ListItemText
                                    primary={translate("CHANGE_PASSWORD")}
                                />
                            </ListItem>
                        </>
                    )}
