...
const ModalClaim = React.memo((props: ModalClaimProps) => {
      ...
      >
        <Fade in={open}>
          <div className={classes.paper}>
            <h2 className={classes.title}>{translate("CLAIM_TITLE")}</h2>
            <form
            ...
            >
              ...
              />
              <Input
                name="orgnizationWebsite"
                type="text"
                fullWidth
                validate={register({
                  required: true
                })}
                placeholder="Orgnization Website"
                label={"Orgnization Website"}
                error={errors.title}
              />
              <Input
                name="email"
              ...
              >
                <Grid item xs={6} sm={6} md={6} lg={6}>
                  <ButtonGroup onClick={handleClose} fullWidth>
                    <ButtonOutline variant="contained">
                      {translate("CANCEL")}
                    </ButtonOutline>
                  </ButtonGroup>
                </Grid>
