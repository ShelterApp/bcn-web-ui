...
const ServiceItem = React.memo((props: ServiceItemProps) => {
  ...
  const summary =
    toLang === "en" ? service.serviceSummary : service.serviceSummaryEs;
  const description =
    toLang === "en" ? service.description : service.descriptionEs;
  ...
  const renderCategory = () => {
    const age = toLang === "en" ? service.age : service.ageEs;
      ...
      <Container className={classes.root}>
        ...
        {!!service.availableBeds && (
          <div className={clsx(classes.borderItem, classes.desc)}>
            <span>
              {translate("AVAILABLE_TOTAL_BEDS")}: {service.availableBeds}/
              {service.totalBeds}
            </span>
          </div>
        )}
          ...
          <div className={classes.textCenter}>
            <ButtonGroup>
              <Button
                ...
                variant="contained"
              >
                {translate("REPORT_SERVICE_INFO")}
              </Button>
            </ButtonGroup>
            <ButtonGroup>
              <Button
                onClick={() => onClickClaim(service)}
                className={classes.connectBtn}
                variant="contained"
              >
                {translate("CLAIM_SERVICE")}
              </Button>
            </ButtonGroup>
          </div>
        )}
