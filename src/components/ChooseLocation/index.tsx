    ...
    <div className={clsx(classes.fullList)}>
      ...
      <List className={clsx(classes.pb0, classes.shrink0)}>
        <ListItem className={clsx(classes.rootListItem, classes.borderBot)}>
          <div className={classes.search}>
            ...
            <InputBase
              ...
              placeholder={translate("SEARCH_CITY_NAME_OR_ZIP_CODE")}
              classes={{
        ...
        {isHaveCurrentLocation && (
          ...
          >
            <p className={classes.location}>{translate("CURRENT_LOCATION")}</p>
          </ListItem>
        )}
      </List>
      {hasData && (
      ...
      {value !== "" &&
        value !== translate("CURRENT_LOCATION") &&
        !loading &&
        !hasData && (
          <List>
            <ListItem className={classes.rootListItem}>
              <p className={classes.noMatch}>
                <i>{translate("NO_MATCHING_RESULTS_FOUND")}</i>
              </p>
            </ListItem>
          </List>
        )}
