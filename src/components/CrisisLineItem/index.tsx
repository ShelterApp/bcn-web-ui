    ...
    <div className={classes.card}>
      ...
      >
        ...
        <div>
          {!!chatWebLink && (
            ...
            >
              <MdChatboxes color="#472F92" fontSize="18px" />
            </a>
          )}
          {!!website && (
            <a
            ...
            >
              <MdGlobe color="#472F92" fontSize="18px" />
            </a>
          )}
        </div>
      </div>
      {(phone || !!text) && (
        <p className={clsx(classes.desc)}>
          ...
          <span className={classes.itemPhone}>
            {text && (
              <>
                <IosChatboxes color="#472F92" fontSize="18px" />
                {text}
              </>
            )}
          </span>
      ...
      <div className={clsx(classes.lastDesc)}>
        <div className={clsx(classes.first)}>
          {area && (
            <span>
              <span className={classes.font600}>{translate("AREA")}:</span>{" "}
              {area}
            </span>
          )}
          {area && time && ", "}
          {time && (
            <span>
              <span className={classes.font600}>{translate("HOURS")}:</span>{" "}
              {time}
            </span>
          )}
        </div>
        <div className={clsx(classes.second)}>
          {props.isAdmin && (
            <>
              ...
              >
                <MdTrash color="#472F92" fontSize="18px" />
              </IconButton>
            </>
          )}
        </div>
