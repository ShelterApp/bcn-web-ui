...
import LiaisonNew from "pages/Liaisons/create";
import LiaisonEdit from "pages/Liaisons/edit";
import RegionNew from "pages/Regions/create";
import RegionEdit from "pages/Regions/edit";
import Regions from "pages/Regions";
import UnitNew from "pages/Units/create";
...
const Routes = (props: RoutesProps) => (
  ...
  >
    <Switch>
      ...
      <Route exact path="/liaisons" component={Liaisons} />
      <Route exact path="/regions" component={Regions} />
      <Route exact path="/coordinators" component={Units} />
      ...
      <AdminRoute
        path={"/liaisons/new"}
        component={LiaisonNew}
        isAdmin={
          Boolean(props.auth.current_user.isAdmin) ||
          Boolean(props.auth.current_user.roles.includes(UserRole.SuperUser))
        }
        isLoggedIn={Boolean(props.auth.current_user.isLogin)}
      />
      <AdminRoute
        path={"/liaisons/:id/edit"}
      ...
      <PrivateRoute
        ...
        isLoggedIn={Boolean(
          props.auth.current_user.isAdmin ||
            !props.auth.current_user.roles.includes(UserRole.User)
        )}
      />
      <PrivateRoute
